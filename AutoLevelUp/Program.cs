...
namespace AutoSpellUp
{
    class Program
    {
        ...
        {
            Menu = new Menu("AutoLevelUp", "AutoLevelUp",true);
            {
                Menu.AddItem(new MenuItem("delay", "Max. Delay").SetValue(new Slider(1000, 1, 10000)));
                Menu.AddToMainMenu();
            }

            var smite = ObjectManager.Player.Spellbook.Spells.FirstOrDefault(o => o.SData.Name == "summonerSmite");
        ...
        {
            Utility.DelayAction.Add(new Random().Next(0, Delay), () =>
